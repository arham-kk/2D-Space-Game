...
projectile_image = pygame.transform.scale(pygame.image.load("projectile.png"), (50, 50))
explosion_image = pygame.transform.scale(pygame.image.load("blast.png"), (50, 50))
...
gameover_image = pygame.transform.scale(pygame.image.load("gameover.png"), (400, 250))
